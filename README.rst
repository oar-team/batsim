...
.. |last-release| image:: https://img.shields.io/badge/release-v3.1.0-blue.svg
    :alt: last release
    :scale: 100%
    :target: https://github.com/oar-team/batsim/releases/tag/v3.1.0

.. |distance-from-previous-release| image:: https://img.shields.io/github/commits-since/oar-team/batsim/v3.1.0.svg
    :alt: distance from previous release
    :scale: 100%
    :target: https://github.com/oar-team/batsim/compare/v3.1.0...HEAD
