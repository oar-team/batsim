...
.. warning::
   ...
   This is all the more important for codes in the Batsim ecosystem that are external to Batsim itself (e.g., pybatsim_ scheduling algorithms), which are much less tested than Batsim.
   Please do :ref:`contact_us` in case of doubt.


Batsim is a scientific infrastructure simulator that enables the study of resource management techniques, such as batch schedulers.
...
- Use sound simulation models thanks to SimGrid_.
- Develop algorithms (in any programming language) without SimGrid knowledge, or plug existing algorithm implementations to Batsim. Done thanks to a :ref:`protocol` between Batsim and the schedulers.
...
The present documentation focuses on Batsim's technical aspects.
