...
do
    ...
    # Execute batsim
    batsim -e ${EXPE_DIR}/${algo}/out_ -p ${EXPE_DIR}/platform.xml -w ${EXPE_DIR}/workload.json -q --mmax-workload 2>/dev/null
done
```
...
implicit_instances:
  block1: # Within each block, the combination of defined sweep variables is done. Multiple blocks can be defined.
    ...
    generic_instance:
      ...
      batsim_command: batsim -p ${platform[filename]} -w ${workload[filename]} -e ${output_directory}/out_ --mmax-workload
